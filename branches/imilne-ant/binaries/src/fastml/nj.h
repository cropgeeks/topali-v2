...
public:
  ...
  tree computeNJtree(VVdouble distances ,const vector<string>& names, const tree& constriantTree);
...
/*
	...
	void computeNJtree(const sequenceContainer& sd,const computeDistance* cd,const vector<MDOUBLE> * weights = NULL);
