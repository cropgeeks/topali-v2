...
public class MGLocalJob extends AnalysisJob
{
	private SequenceSet ss;

	private File jobDir;

	public MGLocalJob(MGResult result, AlignmentData data)
	{
		this.result = result;    
		this.data = data;
	...
	public String ws_submitJob() throws Exception
	{
		try
		{
			new RunModelGenerator(jobDir, ss, (MGResult) result).start();
	...
	{
		result = new MGMonitor(jobDir).getResult();
