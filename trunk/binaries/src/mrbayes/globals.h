...
extern MrBFlt			constraintAges[MAX_NUM_CONSTRAINTS];    /* holds ages of constraints                     */
...
extern int				echo;							   	    /* flag used by Manual to prevent echoing        */
...
extern int				isUserTreeRooted;                       /* flag indicating rootedness of user tree       */
...
extern PropInfo			parameterInformation[100];              /* information on the parameter proposals        */
...
extern MrBFlt			proParam[NUM_MOVE_TYPES][2];            /* holds proposal parameters, like LOCAL tuning  */
...
extern MrBFlt			relProbs[NUM_MOVE_TYPES];               /* holds relative probabilities of moves         */
...
extern TreeNode			*userNodes;                             /* user tree                                     */
extern TreeNode			*userRoot;                              /* root of user tree                             */
