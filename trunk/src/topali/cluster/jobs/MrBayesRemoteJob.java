...
public class MrBayesRemoteJob extends RemoteJob
{
	...
	public MrBayesRemoteJob(MBTreeResult result, AlignmentData data)
	{
		super("topali-mb", result);
	...
	{
		call = getCall();
		call.setOperationName(new QName("topali-mb", "getPercentageComplete"));
	...
	{
		call = getCall();
		call.setOperationName(new QName("topali-mb", "getResult"));
