...
//		try
//		{
//			FLASH_RED = new ImageIcon(getClass().getResource("/res/icons/flash_red.gif"));
//			FLASH_BLU = new ImageIcon(getClass().getResource("/res/icons/flash_blu.gif"));
//		}
	...
	public static void setStatusIcon(byte icon)
	{
		...
		switch (icon)
		{
			case OFF:
				...
				break;
			case RED: jobIconLabel.setIcon(Icons.STATUS_RED); 
				jobIconLabel.setToolTipText("One or more jobs are in an error state");
				break;
			case BLU: jobIconLabel.setIcon(Icons.STATUS_BLU); 
				jobIconLabel.setToolTipText("One or more jobs have intermittent problems");
				break;
			case GRE: jobIconLabel.setIcon(Icons.STATUS_GRE); 
