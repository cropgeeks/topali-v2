...
public class HMMResultsPanel extends GraphResultsPanel
{
	...
	public HMMResultsPanel(AlignmentData data, HMMResult result)
	{
		...
		graph1.setBorder(BorderFactory.createTitledBorder("Probability of topology 1 (1,2), (2,3):"));
		...
		graph2.setBorder(BorderFactory.createTitledBorder("Probability of topology 2 (1,3), (2,4):"));
		...
		graph3.setBorder(BorderFactory.createTitledBorder("Probability of topology 3 (1,4), (2,3):"));
