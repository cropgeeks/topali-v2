...
public class LRTSettingsDialog extends JDialog implements ActionListener
{
	...
	public LRTSettingsDialog(WinMain winMain, AlignmentData data, LRTResult iResult)
	{
...
//				basicPanel.stepSpin.requestFocus();
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		else if (e.getSource() == bRun)
		{
			...
			createLRTObject((e.getModifiers() & e.CTRL_MASK) == 0);
			setVisible(false);
		}
	...
	private void defaultClicked()
	{
		int res = MsgBox.yesno(
			Text.GuiDiag.getString("LRTSettingsDialog.gui06"), 1);
