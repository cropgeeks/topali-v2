...
public abstract class AnalysisJob
{
	...
	public abstract String ws_submitJob() throws Exception;

	public abstract JobStatus ws_getProgress() throws Exception;

	public abstract AnalysisResult ws_downloadResult() throws Exception;

	public abstract void ws_cleanup() throws Exception;

	public abstract void ws_cancelJob() throws Exception;
}