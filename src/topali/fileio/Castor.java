...
public class Castor
{
	...
	static
	{		
		org.exolab.castor.util.LocalConfiguration.getInstance()
...
/*	public static SequenceSet getSequenceSet(String xml)
		throws Exception
	{
		Castor.initialise();
		Unmarshaller unmarshaller = new Unmarshaller(SequenceSet.class);
		unmarshaller.setWhitespacePreserve(true);
	...
	public static PDMResult getPDMResult(String xml)
		throws Exception
	{
		Castor.initialise();
		Unmarshaller unmarshaller = new Unmarshaller(PDMResult.class);
		unmarshaller.setMapping(getMapping());

		return (PDMResult) unmarshaller.unmarshal(new StringReader(xml));
	}

	public static HMMResult getHMMResult(String xml)
		throws Exception
	{
		Castor.initialise();
		Unmarshaller unmarshaller = new Unmarshaller(HMMResult.class);
		unmarshaller.setMapping(getMapping());
...
//		unmarshaller.setMapping(getMapping());
	...
	{
		Castor.initialise();
		Unmarshaller unmarshaller = new Unmarshaller(LRTResult.class);
		unmarshaller.setMapping(getMapping());
		
		return (LRTResult) unmarshaller.unmarshal(new StringReader(xml));
	}
	
	public static MBTreeResult getMBTreeResult(String xml)
		throws Exception
	{
		Castor.initialise();
		Unmarshaller unmarshaller = new Unmarshaller(MBTreeResult.class);
		unmarshaller.setMapping(getMapping());
		
		return (MBTreeResult) unmarshaller.unmarshal(new StringReader(xml));
	}
	
	public static JobStatus getJobStatus(String xml)
		throws Exception
	{
		Castor.initialise();
		Unmarshaller unmarshaller = new Unmarshaller(JobStatus.class);
		unmarshaller.setMapping(getMapping());
...
/*	public static Mapping get3Mapping()
