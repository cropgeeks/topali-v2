...
//	
//	static HashMap<String, LinkedList<DbRef>> dbRefMapping = VamsasManager.dbRefMapping;
//	
//	public CopyOfDocumentHandler(Project proj, IClientDocument doc)
//	{
//		this.project = proj;
//		this.doc = doc;
//
...
//							LinkedList<DbRef> dbrefs = dbRefMapping.get(tSeq.name);
//							if(dbrefs==null)
//								dbrefs = new LinkedList<DbRef>();
//							dbrefs.add(dbref);
//							VamsasManager.dbRefMapping.put(tSeq.name, dbrefs);
//							found = true;
...
//				}
//				
//				if(VamsasManager.dbRefMapping.containsKey(tSeq.name)) {
//					for(DbRef ref : VamsasManager.dbRefMapping.get(tSeq.name)) {
//						DbRef copyRef = new DbRef();
//						copyRef.setAccessionId(ref.getAccessionId());
//						copyRef.setSource(ref.getSource());
//						vDSSequence.addDbRef(copyRef);
//					}
//					VamsasManager.dbRefMapping.remove(tSeq);
//				}
//				
