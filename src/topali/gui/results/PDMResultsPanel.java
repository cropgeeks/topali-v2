...
public class PDMResultsPanel extends GraphResultsPanel implements
		MouseMotionListener, MouseListener
{
	...
	public PDMResultsPanel(AlignmentData data, PDMResult result)
	{
		...
		p2.setBorder(BorderFactory
				.createTitledBorder("Probability distribution ("
						+ result.histograms[0].length + "):"));
		p2.add(histoPanel);
	...
	protected void savePNG(File f) throws Exception
	{
		...
		MsgBox.msg(
				"Graph data successfully saved to:\n" + gName + "\n" + lName,
				MsgBox.INF);
	}
