...
public class PDM2SettingsDialog extends JDialog implements ActionListener
{
	...
	public PDM2SettingsDialog(WinMain winMain, AlignmentData data, PDM2Result iResult)
	{
		super(winMain, "Probabilistic Divergence Measures (Enhanced) - Confirm Settings", true);
		this.data = data;
	...
	class BasicPanel extends JPanel
	{
		...
		BasicPanel()
		{
			slidePanel = new SlidePanel(data, Prefs.pdm2_window, Prefs.pdm2_step);
