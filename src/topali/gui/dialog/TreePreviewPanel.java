...
class TreePreviewPanel extends JPanel implements ActionListener
{
	...
	TreePreviewPanel(WinMain winMain, PartitionDialog pDialog)
	{
		...
		checkCurrent.setToolTipText(Text.GuiDiag.getString("TreePreviewPanel.gui02"));
	...
	Runnable r = new Runnable() { public void run() {
		...
		// If the time taken to generate the tree is greater than 1.25 seconds
		if ((e-s) >= 1250 && slowWarningShown == false)
		{
			String msg = Text.GuiDiag.getString("TreePreviewPanel.msg01");
			
			// Offer to disable generating tree previews for this alignment
	...
	class TreeCanvas extends JPanel
	{
		TreeCanvas()
		{
			...
			setToolTipText(Text.GuiDiag.getString("TreePreviewPanel.gui03"));
