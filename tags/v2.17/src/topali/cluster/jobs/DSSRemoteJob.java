...
public class DSSRemoteJob extends RemoteJob
{
	...
	public String ws_submitJob() throws Exception
	{
		...
		Tracker.log("SUBMITTED", "DSS", result.jobId, url);
	...
	{
		call = getCall();
		call.setOperationName(new QName("topali-dss", "getPercentageComplete"));
	...
	{
		call = getCall();
		call.setOperationName(new QName("topali-dss", "getResult"));

		String resultXML = (String) call.invoke(new Object[]
		{ result.jobId });
		result = (DSSResult) Castor.unmarshall(resultXML);
