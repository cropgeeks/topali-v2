...
//	}
//
//	public void addCurrentRegion()
//	{
//		addRegion(alignData.getActiveRegionS(), alignData.getActiveRegionE());
//	}
//
//	// Adds a new partition to the current list
//	public boolean addRegion(int start, int end)
//	{
//		// Check it doesn't already exist
//		Region r = new Region(start, end);
//
//		List<Annotation> annotations = alignData.getAnnotations().getAnnotations(PartitionAnnotation.class);
//		
...
//		alignData.getAnnotations().add(anno);
//		
//		refreshList();
//
...
//			PartitionAnnotation anno = (PartitionAnnotation) annotations.get(i);
//			regionModel.addElement(anno.getStart()+" - "+anno.getEnd());
//		}
//		
//		checkList();
//	}
//	
//	private int getIndex(PartitionAnnotation anno) {
//		for(int i=0; i<regionModel.size(); i++) {
//			String tmp = (String)regionModel.get(i);
//			String[] tmp2 = tmp.split("\\s+");
//			int s = Integer.parseInt(tmp2[0]);
//			int e = Integer.parseInt(tmp2[2]);
//			if(s==anno.getStart() && e==anno.getEnd())
//				return i;
//		}
//		return -1;
//	}
