  ...
  { 
	...
	do 
	  {		
		...
		d1 = &(d_start[model * tr->NumberOfCategories * 19 + 19 * *cptr++]);	
		e  = &(e_start[model * 19]);
		s  = &(s_start[model * 19]);
  ...
  { 	
	...
	if(r->tip || q->tip)
	 ...
	 {       
	   ...
	   lz2[0] = EIGN[modelCounter * 19] * z2;
	   lz2[1] = EIGN[modelCounter * 19 + 1] * z2;
	   lz2[2] = EIGN[modelCounter * 19 + 2] * z2;
	   lz2[3] = EIGN[modelCounter * 19 + 3] * z2;
	   lz2[4] = EIGN[modelCounter * 19 + 4] * z2;
	   lz2[5] = EIGN[modelCounter * 19 + 5] * z2;
	   lz2[6] = EIGN[modelCounter * 19 + 6] * z2;
	   lz2[7] = EIGN[modelCounter * 19 + 7] * z2;
	   lz2[8] = EIGN[modelCounter * 19 + 8] * z2;
	   lz2[9] = EIGN[modelCounter * 19 + 9] * z2;
	   lz2[10] = EIGN[modelCounter * 19 + 10] * z2;
	   lz2[11] = EIGN[modelCounter * 19 + 11] * z2;
	   lz2[12] = EIGN[modelCounter * 19 + 12] * z2;
	   lz2[13] = EIGN[modelCounter * 19 + 13] * z2;
	   lz2[14] = EIGN[modelCounter * 19 + 14] * z2;
	   lz2[15] = EIGN[modelCounter * 19 + 15] * z2;
	   lz2[16] = EIGN[modelCounter * 19 + 16] * z2;
	   lz2[17] = EIGN[modelCounter * 19 + 17] * z2;
	   lz2[18] = EIGN[modelCounter * 19 + 18] * z2;
