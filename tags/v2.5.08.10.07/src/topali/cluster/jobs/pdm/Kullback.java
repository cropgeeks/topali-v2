...
public class Kullback
{
	...
	public Kullback(File wrkDir, Entropy oEntropy) throws JambeException
	{
		...
		if (nTopos <= 0 || nWindows <= 0)
		{
			throw new JambeException(
					"KB01: Wrong parameters in constructor of " + "Kullback.");
		}
	}
	...
	public void findBestTopo() throws JambeException
	{
		...
		if (bestTopo == -1)
		{
			...
			throw new JambeException(
					"KB02: Method findBestTopo must be called after "
	...
	public void showBestTopo()
	{
		...
		System.out.println("Probability of the best topology=  "
				+ histogramAveraged[bestTopo]);
	}
	...
	public void printKullbackMean(File fileName) throws JambeException
	{
		...
		try
		{
			...
			outFile.close();
			System.out
					.println("Kullback-Leibler divergences between p and the averaged distributionare in file "
							+ fileName);
		} catch (IOException e)
		{
	...
	public void printKullbackMode(File fileName) throws JambeException
	{
		...
		try
		{
			...
			outFile.close();
			System.out
					.println("Kullback-Leibler divergences  between p and the  mode of the averaged  distribution are in file "
							+ fileName);
		} catch (IOException e)
		{
