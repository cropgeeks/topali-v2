      ...
      for(model = 0; model < tr->NumberOfModels; model++)
	{
	 ...
	 for (i = 0; i < tr->cdta->endsite; i++) 
	   {	
	     ...
	     uX1 = &umpX1[1840 * model + 80 * *tipX1++];
	     uX2 = &umpX2[1840 * model + 80 * *tipX2++];
	...
	for (i = 0; i < tr->cdta->endsite; i++) 
	  {
	    ...
	    left = &(tr->protTip[23 * model + *tipX1++].v[0]);
	...
	for (i = 0; i < tr->cdta->endsite; i++) 
	  {
	    ...
	    right = &(tr->protTip[23 * model + *tipX2++].v[0]);
	    diagptable = &diagptable_start[76 * model];
  ...
  { /* makenewz */
	...
	for (i = 0; i < tr->cdta->endsite; i++) 
	  {   
	    ...
	    left = &(tr->protTip[model * 23 + *tipX1++].v[0]);
	    right = &(tr->protTip[model * 23 + *tipX2++].v[0]);      
	...
	modelptr = tr->model;
        ...
        for (i = 0; i < tr->cdta->endsite; i++) 
	  {
	    ...
	    diagptable = &diagptable_start[228 * *modelptr++];
