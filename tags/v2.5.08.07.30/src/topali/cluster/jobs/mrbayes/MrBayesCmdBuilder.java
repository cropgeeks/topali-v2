...
public class MrBayesCmdBuilder
{
	...
	public String getCommands()
	{
		...
		if (!isCDNA)
		{
			...
			sb.append("\tcharset 1st_pos = 1-.\\3;\n");
			sb.append("\tcharset 2nd_pos = 2-.\\3;\n");
			sb.append("\tcharset 3rd_pos = 3-.\\3;\n");
			sb.append("\tpartition bycodon = 3:1st_pos,2nd_pos,3rd_pos;\n");
			sb.append("\tset partition=bycodon;\n");
	...
	public boolean isCDNA()
	{
		return isCDNA;
	}

	public void setCDNA(boolean isCDNA)
	{
		this.isCDNA = isCDNA;
	}
